...
| 48 | decision trees, impurity, entropy, and split criteria | [Decision-tree splits and information gain](session-48-decision-tree-splits-and-information-gain.md) | split/purity calculation and tree explanation |
| 49 | random forests, bagging, averaging, and variance reduction | [Bagging and random forests](session-49-bagging-and-random-forests.md) | single-tree/forest comparison and embedded Kaggle result |
...
- [Mathematics transition bridge](Andrew_ML_Mathematics_Bridge.md)
