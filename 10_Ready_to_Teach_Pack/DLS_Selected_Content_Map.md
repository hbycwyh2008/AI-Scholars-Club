...
|---|---|---|
| Course 1 — Neural Networks and Deep Learning | forward propagation and representation review | [Session 47](../02_Class_Missions/05_Andrew_Ng_ML_Model_Labs/session-47-neural-network-bridge.md) and [Session 60](../02_Class_Missions/06_Andrew_Ng_DL_PyTorch/session-60-forward-propagation.md) |
